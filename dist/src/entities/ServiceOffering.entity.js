...
__decorate([
    (0, typeorm_1.Column)('uuid', { name: 'specialists' }),
    __metadata("design:type", String)
], ServiceOffering.prototype, "specialists", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Specialist_entity_1.Specialist, (specialist) => specialist.service_offerings, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'specialists' }),
...
//# sourceMappingURL=ServiceOffering.entity.js.map