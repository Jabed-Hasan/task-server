...
const specialist_routes_1 = require("../Specialist/specialist.routes");
const provider_routes_1 = require("../Provider/provider.routes");
...
const moduleRoutes = [
    ...
    {
        path: '/providers',
        route: provider_routes_1.ProviderRoutes,
    }
];
