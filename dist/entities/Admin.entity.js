...
__decorate([
    ...
    __metadata("design:type", String)
], Admin.prototype, "profilePhoto", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToOne)(() => require('./User.entity').User, (user) => user.admin),
    (0, typeorm_1.JoinColumn)({ name: 'email', referencedColumnName: 'email' }),
